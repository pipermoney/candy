...
export default async function CharactersPage() {
  ...
  const charactersArtworks = allArtworks.filter((artwork) => artwork.category === "Characters")
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 pt-32 pb-24 max-w-6xl">
        <ScrollReveal>
          <h1 className="text-3xl font-light mb-4">Characters</h1>
          <p className="text-lg text-gray-600 mb-12">
            A collection exploring digital identity and character creation through various media.
          </p>
        </ScrollReveal>

        <Suspense fallback={<div className="h-screen flex items-center justify-center">Loading...</div>}>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {charactersArtworks.map((artwork, index) => (
